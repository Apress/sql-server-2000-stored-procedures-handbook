...
RETURNS TABLE
AS
RETURN (SELECT o.OrderDate, o.RequiredDate, s.CompanyName AS
       ...
       WHERE o.ShippedDate IS NULL AND o.CustomerId = @CustId
       GROUP BY customerid, o.OrderDate, o.RequiredDate, 
         s.CompanyName)
